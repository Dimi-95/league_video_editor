...
while(True):
    ...
    if(condition_counter - 1 != 0):
        ...
        if(all_kills[i] != all_kills[i + 1]):
            ...
            clip_container.append(length_of_clip)
        ...
        print(f"seconds from begin to starting point: {begin_to_start}")
        break

 
#begin + seconds of clip

starting_time_ffmpeg = str(begin_to_start[0])
finish_time_ffmpeg   = str(begin_to_start[0] + clip_container[0])
